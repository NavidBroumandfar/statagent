...
class SurvivalMixtureModel:
    ...
    def compute_statistics(self) -> Dict[str, float]:
        ...
        return {"mean": float(EY), "variance": float(VarY), "std": float(np.sqrt(VarY))}

    def simulate(
        self, n: int = 100000, random_state: Optional[int] = None
    ) -> np.ndarray:
        """
